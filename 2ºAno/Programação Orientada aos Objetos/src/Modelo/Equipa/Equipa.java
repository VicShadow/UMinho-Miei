...
public class Equipa implements Serializable {
  ...
  Map getJogadores() {
    return this.jogadores; //Agregacao
            //.values().stream().map(Jogador :: clone)
            //.collect(Collectors.toMap(e->e.getNumero(),e -> e));
  }
  Map getTreinadores() {
    return this.treinadores; //Agregacao
            //.values().stream().map(Treinador::clone)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(getNome(), equipa.getNome()) && //OBJETC EQUALS WORKS FINE I THINK RIGHT??
